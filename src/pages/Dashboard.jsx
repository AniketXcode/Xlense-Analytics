...
export default function Dashboard() {
  ...
  return (
    <div className={cn("relative flex w-full min-h-screen flex-col overflow-hidden bg-gradient-to-br from-neutral-900 to-neutral-950 text-white")}>

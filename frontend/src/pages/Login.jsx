  ...
  return (
    <AuthLayout>
      ...
      <p className="text-gray-400 mb-6">
        Sign in to your Xlense Analytics account to continue exploring insights.
      </p>
      ...
      <form onSubmit={handleLogin}>
        ...
        <input
          ...
          onChange={handleChange}
          required
          className="w-full px-4 py-2 mb-3 rounded bg-gray-900 text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-600"
        />
